...
ServerEvents.recipes((event) => {
	...
	event.remove({
		output: "create_mechanical_extruder:mechanical_brass_extruder",
	});
	...
	event.remove({ input: ["tfmg:copper_wire"] });
	...
	event.remove({
		id: "create:fill_minecraft_bucket_with_crowns_uranium_hexafluoride",
	});

	//DreamsAndDesires

	event.remove({ output: ["dndesires:gold_whisk"] });
	...
	event.remove({ output: ["tfmg:concrete_hose"] });
	...
	event.shaped("create:mechanical_press", ["A", "B", "C"], {
		A: "create:andesite_casing",
		B: "kubejs:wooden_mechanism",
		C: "minecraft:iron_block",
	});

	event.shaped("2x create:mechanical_press", ["A", "B", "C"], {
		A: "create:andesite_casing",
		B: "kubejs:andesite_alloy_mechanism",
		C: "minecraft:iron_block",
	});

	event.shaped("4x create:mechanical_press", ["A", "B", "C"], {
		A: "create:andesite_casing",
		B: "create:precision_mechanism",
		C: "minecraft:iron_block",
	});

	event.shaped("8x create:mechanical_press", ["A", "B", "C"], {
		A: "create:andesite_casing",
		B: "tfmg:steel_mechanism",
		C: "minecraft:iron_block",
	});

	event.shaped("16x create:mechanical_press", ["A", "B", "C"], {
		A: "create:andesite_casing",
	...
	event.shaped("2x create:millstone", ["A", "B", "C"], {
		A: "create:andesite_casing",
		B: "kubejs:andesite_alloy_mechanism",
		C: "#c:stones",
	});

	event.shaped("4x create:millstone", ["A", "B", "C"], {
		A: "create:andesite_casing",
		B: "create:precision_mechanism",
		C: "#c:stones",
	});

	event.shaped("8x create:millstone", ["A", "B", "C"], {
		A: "create:andesite_casing",
		B: "tfmg:steel_mechanism",
		C: "#c:stones",
	});

	event.shaped("16x create:millstone", ["A", "B", "C"], {
		A: "create:andesite_casing",
		B: "kubejs:nickel_aluminide_mechanism",
		C: "#c:stones",
	});

	event.shaped("create:water_wheel", ["AAA", "ABA", "AAA"], {
	...
	event.shaped("2x create:windmill_bearing", ["A", "B", "C"], {
		A: "#minecraft:wooden_slabs",
		B: "kubejs:andesite_alloy_mechanism",
		C: "#c:stones",
	});

	event.shaped("4x create:windmill_bearing", ["A", "B", "C"], {
		A: "#minecraft:wooden_slabs",
		B: "create:precision_mechanism",
		C: "#c:stones",
	});

	event.shaped("8x create:windmill_bearing", ["A", "B", "C"], {
		A: "#minecraft:wooden_slabs",
		B: "tfmg:steel_mechanism",
		C: "#c:stones",
	});

	event.shaped("16x create:windmill_bearing", ["A", "B", "C"], {
		A: "#minecraft:wooden_slabs",
		B: "kubejs:nickel_aluminide_mechanism",
		C: "#c:stones",
	});

	event.shaped("3x create:encased_chain_drive", ["A", "B", "C"], {
		A: "create:shaft",
		B: "create:andesite_casing",
		C: "minecraft:chain",
	});

	event.shaped("8x minecraft:chain", ["A", "B", "A"], {
		A: "minecraft:iron_nugget",
	...
	event.shaped("create:transmitter", [" A ", "BCB", "DDD"], {
	...
	event.shaped("createaddition:rolling_mill", ["ABA", "CDC", " E "], {
		A: "create:iron_sheet",
		B: "create:shaft",
	...
	event.shaped("2x createaddition:rolling_mill", ["ABA", "CDC", " E "], {
		A: "create:iron_sheet",
		B: "create:shaft",
		C: "create:andesite_alloy",
	...
	event.shaped("4x createaddition:rolling_mill", ["ABA", "CDC", " E "], {
		A: "create:iron_sheet",
		B: "create:shaft",
		C: "create:andesite_alloy",
	...
	event.shaped("8x createaddition:rolling_mill", ["ABA", "CDC", " E "], {
		A: "create:iron_sheet",
		B: "create:shaft",
		C: "create:andesite_alloy",
	...
	event.shaped("16x createaddition:rolling_mill", ["ABA", "CDC", " E "], {
		A: "create:iron_sheet",
		B: "create:shaft",
		C: "create:andesite_alloy",
	...
	event.shaped("2x create:rope_pulley", ["A", "B", "C"], {
		A: "#c:ropes",
		B: "kubejs:andesite_alloy_mechanism",
		C: "create:iron_sheet",
	});

	event.shaped("4x create:rope_pulley", ["A", "B", "C"], {
		A: "#c:ropes",
		B: "create:precision_mechanism",
		C: "create:iron_sheet",
	});

	event.shaped("8x create:rope_pulley", ["A", "B", "C"], {
		A: "#c:ropes",
		B: "tfmg:steel_mechanism",
		C: "create:iron_sheet",
	});

	event.shaped("16x create:rope_pulley", ["A", "B", "C"], {
		A: "#c:ropes",
		B: "kubejs:nickel_aluminide_mechanism",
		C: "create:iron_sheet",
	});

	const pumpMaterial = ["brass", "steel", "aluminum", "cast_iron", "plastic"];
	for (const type of pumpMaterial) {
		event.shapeless(Item.of(`tfmg:${type}_mechanical_pump`), [
	...
	for (const type of pumpMaterial) {
		event.shapeless(Item.of(`2x tfmg:${type}_mechanical_pump`), [
	...
	for (const type of pumpMaterial) {
		event.shapeless(Item.of(`4x tfmg:${type}_mechanical_pump`), [
	...
	for (const type of pumpMaterial) {
		event.shapeless(Item.of(`8x tfmg:${type}_mechanical_pump`), [
	...
	for (const type of pumpMaterial) {
		event.shapeless(Item.of(`16x tfmg:${type}_mechanical_pump`), [
			"kubejs:nickel_aluminide_mechanism",
			`tfmg:${type}_pipe`,
		]);
	}

	event.shapeless(Item.of("create:mechanical_pump"), [
		"kubejs:wooden_mechanism",
		"create:fluid_pipe",
	]);

	event.shapeless(Item.of("2x create:mechanical_pump"), [
		"kubejs:andesite_alloy_mechanism",
		"create:fluid_pipe",
	]);

	event.shapeless(Item.of("4x create:mechanical_pump"), [
		"create:precision_mechanism",
		"create:fluid_pipe",
	]);

	event.shapeless(Item.of("8x create:mechanical_pump"), [
		"tfmg:steel_mechanism",
		"create:fluid_pipe",
	]);

	event.shapeless(Item.of("16x create:mechanical_pump"), [
		"kubejs:nickel_aluminide_mechanism",
		"create:fluid_pipe",
	]);
	...
	event.shaped("create:mechanical_mixer", ["A", "B", "C"], {
		A: "create:andesite_casing",
		B: "kubejs:andesite_alloy_mechanism",
		C: "create:whisk",
	});

	event.shaped("2x create:mechanical_mixer", ["A", "B", "C"], {
		A: "create:andesite_casing",
		B: "create:precision_mechanism",
		C: "create:whisk",
	});

	event.shaped("4x create:mechanical_mixer", ["A", "B", "C"], {
		A: "create:andesite_casing",
		B: "tfmg:steel_mechanism",
		C: "create:whisk",
	});

	event.shaped("8x create:mechanical_mixer", ["A", "B", "C"], {
		A: "create:andesite_casing",
		B: "kubejs:nickel_aluminide_mechanism",
		C: "create:whisk",
	});

	event.shaped("create:mechanical_bearing", ["A", "B", "C"], {
		A: "#minecraft:wooden_slabs",
		B: "kubejs:andesite_alloy_mechanism",
		C: "create:shaft",
	});

	event.shaped("2x create:mechanical_bearing", ["A", "B", "C"], {
		A: "#minecraft:wooden_slabs",
		B: "create:precision_mechanism",
		C: "create:shaft",
	});

	event.shaped("4x create:mechanical_bearing", ["A", "B", "C"], {
		A: "#minecraft:wooden_slabs",
		B: "tfmg:steel_mechanism",
		C: "create:shaft",
	});

	event.shaped("8x create:mechanical_bearing", ["A", "B", "C"], {
		A: "#minecraft:wooden_slabs",
		B: "kubejs:nickel_aluminide_mechanism",
		C: "create:shaft",
	});

	event.shaped("create:mechanical_drill", [" A ", "ABA", " C "], {
		A: "create:andesite_alloy",
		B: "kubejs:andesite_alloy_mechanism",
		C: "create:andesite_casing",
	});

	event.shaped("2x create:mechanical_drill", [" A ", "ABA", " C "], {
		A: "create:andesite_alloy",
		B: "create:precision_mechanism",
		C: "create:andesite_casing",
	});

	event.shaped("4x create:mechanical_drill", [" A ", "ABA", " C "], {
		A: "create:andesite_alloy",
		B: "tfmg:steel_mechanism",
		C: "create:andesite_casing",
	});

	event.shaped("8x create:mechanical_drill", [" A ", "ABA", " C "], {
		A: "create:andesite_alloy",
		B: "kubejs:nickel_aluminide_mechanism",
		C: "create:andesite_casing",
	});

	event.shaped("create:mechanical_harvester", ["ABA", " C ", " D "], {
		A: "create:andesite_alloy",
		B: "create:iron_sheet",
	...
	event.shaped("2x create:mechanical_harvester", ["ABA", " C ", " D "], {
		A: "create:andesite_alloy",
		B: "create:iron_sheet",
	...
	event.shaped("4x create:mechanical_harvester", ["ABA", " C ", " D "], {
		A: "create:andesite_alloy",
		B: "create:iron_sheet",
	...
	event.shaped("8x create:mechanical_harvester", ["ABA", " C ", " D "], {
		A: "create:andesite_alloy",
		B: "create:iron_sheet",
	...
	event.shaped("create:chain_conveyor", [" A ", "ABA", " C "], {
		A: "create:andesite_casing",
		B: "kubejs:andesite_alloy_mechanism",
		C: "dndecor:large_industrial_cogwheel",
	});

	event.shaped("2x create:chain_conveyor", [" A ", "ABA", " C "], {
		A: "create:andesite_casing",
		B: "create:precision_mechanism",
		C: "dndecor:large_industrial_cogwheel",
	});

	event.shaped("4x create:chain_conveyor", [" A ", "ABA", " C "], {
		A: "create:andesite_casing",
		B: "tfmg:steel_mechanism",
		C: "dndecor:large_industrial_cogwheel",
	});

	event.shaped("8x create:chain_conveyor", [" A ", "ABA", " C "], {
		A: "create:andesite_casing",
		B: "kubejs:nickel_aluminide_mechanism",
		C: "dndecor:large_industrial_cogwheel",
	});

	event.shaped("create:hose_pulley", [" D ", "ABA", " C "], {
	...
	event.shaped("2x create:hose_pulley", [" D ", "ABA", " C "], {
		A: "create:copper_sheet",
		B: "create:precision_mechanism",
		C: "create:fluid_pipe",
		D: "create:belt_connector",
	...
	event.shaped("4x create:hose_pulley", [" D ", "ABA", " C "], {
		A: "create:copper_sheet",
		B: "tfmg:steel_mechanism",
		C: "create:fluid_pipe",
		D: "create:belt_connector",
	...
	event.shaped("8x create:hose_pulley", [" D ", "ABA", " C "], {
		A: "create:copper_sheet",
		B: "kubejs:nickel_aluminide_mechanism",
		C: "create:fluid_pipe",
		D: "create:belt_connector",
	...
	event.shaped("create:elevator_pulley", [" D ", "ABA", " C "], {
	...
	event.shaped("2x create:elevator_pulley", [" D ", "ABA", " C "], {
		A: "create:brass_sheet",
		B: "create:precision_mechanism",
		C: "create:iron_sheet",
		D: "create:belt_connector",
	...
	event.shaped("4x create:elevator_pulley", [" D ", "ABA", " C "], {
		A: "create:brass_sheet",
		B: "tfmg:steel_mechanism",
		C: "create:iron_sheet",
		D: "create:belt_connector",
	...
	event.shaped("8x create:elevator_pulley", [" D ", "ABA", " C "], {
		A: "create:brass_sheet",
		B: "kubejs:nickel_aluminide_mechanism",
		C: "create:iron_sheet",
		D: "create:belt_connector",
	...
	event.shaped("6x create:mechanical_crafter", ["A", "B", "C"], {
		A: "create:electron_tube",
		B: "tfmg:steel_mechanism",
		C: "minecraft:crafting_table",
	});

	event.shaped("12x create:mechanical_crafter", ["A", "B", "C"], {
		A: "create:electron_tube",
		B: "kubejs:nickel_aluminide_mechanism",
		C: "minecraft:crafting_table",
	});

	event.shaped("create:rotation_speed_controller", ["A", "B", "C"], {
		A: "create:electron_tube",
		B: "create:precision_mechanism",
		C: "create:brass_casing",
	});

	event.shaped("2x create:rotation_speed_controller", ["A", "B", "C"], {
		A: "create:electron_tube",
		B: "tfmg:steel_mechanism",
		C: "create:brass_casing",
	});

	event.shaped("4x create:rotation_speed_controller", ["A", "B", "C"], {
		A: "create:electron_tube",
		B: "kubejs:nickel_aluminide_mechanism",
		C: "create:brass_casing",
	});
	...
	event.shaped("2x create:sequenced_gearshift", ["A", "B", "C"], {
		A: "kubejs:electron_circuit_board",
		B: "tfmg:steel_mechanism",
		C: "create:brass_casing",
	});

	event.shaped("4x create:sequenced_gearshift", ["A", "B", "C"], {
		A: "kubejs:electron_circuit_board",
		B: "kubejs:nickel_aluminide_mechanism",
		C: "create:brass_casing",
	});

	event.shaped("create:content_observer", ["A", "B", "C"], {
		A: "create:electron_tube",
		B: "create:brass_casing",
		C: "minecraft:observer",
	});

	event.shaped("create:stockpile_switch", ["A", "B", "C"], {
		A: "kubejs:electron_circuit_board",
		B: "create:brass_casing",
	...
	event.recipes.create.mechanical_crafting(
		"2x createaddition:electric_motor",
		["ABA", "BCB", "ADA"],
		{
			A: "create:brass_sheet",
			B: "createaddition:copper_spool",
	...
	event.recipes.create.mechanical_crafting(
		"4x createaddition:electric_motor",
		["ABA", "BCB", "ADA"],
		{
			A: "create:brass_sheet",
			B: "createaddition:copper_spool",
	...
	event.shaped("2x create:factory_gauge", ["A", "B"], {
		A: "kubejs:electron_circuit_board",
		B: "create:stock_link",
	});
	...
	event.shaped("numismatics:bank_terminal", ["A", "B", "C"], {
		A: "create:electron_tube",
	...
	event.recipes.create.mechanical_crafting(
		"2x create_mechanical_extruder:mechanical_brass_extruder",
		[" A ", "BAB", "CDC", "BEB"],
		{
			A: "create:metal_girder",
			B: "create:brass_sheet",
	...
	event.recipes.create.mechanical_crafting(
		"4x create_mechanical_extruder:mechanical_brass_extruder",
		[" A ", "BAB", "CDC", "BEB"],
		{
			A: "create:metal_girder",
			B: "create:brass_sheet",
	...
	event.shaped("2x dndesires:gold_mixer", ["A", "B", "C"], {
		A: "tfmg:steel_mechanism",
		B: "create:brass_casing",
		C: "dndesires:gold_whisk",
	});

	event.shaped("4x dndesires:gold_mixer", ["A", "B", "C"], {
	...
	event.shaped(
		"16x create_connected:kinetic_battery",
		[" A ", " B ", "CDC"],
		{
			A: "tfmg:steel_mechanism",
			B: "create:brass_casing",
	...
	event.shaped(
		"32x create_connected:kinetic_battery",
		[" A ", " B ", "CDC"],
		{
			A: "kubejs:nickel_aluminide_mechanism",
			B: "create:brass_casing",
	...
	event.shaped("create:mechanical_arm", ["AAB", "A  ", "CD "], {
		A: "create:brass_sheet",
	...
	event.shaped("2x create:mechanical_arm", ["AAB", "A  ", "CD "], {
		A: "create:brass_sheet",
		B: "create:andesite_alloy",
		C: "tfmg:steel_mechanism",
		D: "create:brass_casing",
	...
	event.shaped("4x create:mechanical_arm", ["AAB", "A  ", "CD "], {
		A: "create:brass_sheet",
		B: "create:andesite_alloy",
		C: "kubejs:nickel_aluminide_mechanism",
		D: "create:brass_casing",
	...
	event.shaped("tfmg:steel_distillation_controller", ["ABA", "CDC", "EFE"], {
		A: "tfmg:lead_sheet",
	...
	event.shaped(
		"2x tfmg:steel_distillation_controller",
		["ABA", "CDC", "EFE"],
		{
			A: "tfmg:lead_sheet",
			B: "tfmg:industrial_pipe",
	...
	event.shaped("tfmg:surface_scanner", ["ABA", "ABA", "CDC"], {
		A: "create:electron_tube",
	...
	event.shaped("2x tfmg:surface_scanner", ["ABA", "ABA", "CDC"], {
		A: "create:electron_tube",
		B: "kubejs:electron_circuit_board",
		C: "kubejs:nickel_aluminide_mechanism",
		D: "tfmg:heavy_machinery_casing",
	...
	event.shaped("2x tfmg:engine_gearbox", ["ABA", "CDC", "ACA"], {
		A: "tfmg:screw",
		B: "kubejs:nickel_aluminide_mechanism",
		C: "create:shaft",
		D: "tfmg:steel_casing",
	...
	event.shaped("2x tfmg:machine_input", [" A ", " B ", " C "], {
		A: "create:shaft",
		B: "tfmg:heavy_machinery_casing",
		C: "kubejs:nickel_aluminide_mechanism",
	});

	event.shaped("2x tfmg:pumpjack_crank", ["A A", "BCB", "DED"], {
		A: "#c:strings",
		B: "tfmg:heavy_plate",
		C: "kubejs:nickel_aluminide_mechanism",
		D: "tfmg:rebar",
	...
	event.shaped("2x tfmg:pumpjack_base", ["ABA", "CDC", "EFE"], {
		A: "#c:strings",
	...
	event.shaped("2x tfmg:industrial_mixer", ["ABA", "CDC", "AEA"], {
		A: "tfmg:screw",
		B: "create:shaft",
		C: "kubejs:nickel_aluminide_mechanism",
		D: "tfmg:heavy_machinery_casing",
	...
	event.shaped("2x tfmg:winding_machine", ["ABC", "ADE"], {
		A: "tfmg:steel_ingot",
		B: "create:shaft",
		C: "tfmg:heavy_plate",
		D: "tfmg:heavy_machinery_casing",
	...
	event.shaped("tfmg:concrete_hose", [" A ", "BCB", "DED"], {
	...
	event.shaped("2x tfmg:concrete_hose", [" A ", "BCB", "DED"], {
		A: "create:belt_connector",
		B: "tfmg:steel_pipe",
		C: "kubejs:nickel_aluminide_mechanism",
		D: "tfmg:heavy_plate",
	...
	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("create:track", 1.0)],
			"minecraft:andesite_slab",
			[
				event.recipes.create.deploying("create:incomplete_track", [
	...
	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("railways:track_create_andesite_narrow", 1.0)],
			"minecraft:andesite_slab",
			[
	...
	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("railways:track_create_andesite_wide", 1.0)],
			"create:track",
			[
				event.recipes.create.cutting(
	...
	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("kubejs:loose_brass_mechanism", 1.0)],
			"create:brass_sheet",
			[
				event.recipes.create.deploying(
	...
	event.recipes.create
		...
		.transitionalItem("kubejs:loose_brass_mechanism")
		.loops(1);

	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("kubejs:electron_circuit_board", 1.0)],
			"create:brass_sheet",
			[
				event.recipes.create.deploying(
		...
		.transitionalItem("kubejs:incomplete_electron_circuit_board")
		.loops(1);

	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("kubejs:andesite_alloy_mechanism_casing", 1.0)],
		...
		.transitionalItem("kubejs:incomplete_andesite_alloy_mechanism")
		.loops(1);

	event.recipes.create
		.sequenced_assembly(
			[
				CreateItem.of("kubejs:andesite_alloy_mechanism", 0.9),
		...
		.sequenced_assembly(
			...
			[
				...
				event.recipes.create.filling(
					...
					[
						"kubejs:incomplete_half_complete_nickel_aluminide_mechanism",
						Fluid.of("tfmg:lubrication_oil", 500),
					],
				),
				event.recipes.create.deploying(
					"kubejs:incomplete_half_complete_nickel_aluminide_mechanism",
	...
	event.recipes.create
		...
		.transitionalItem("kubejs:incomplete_nickel_aluminide_mechanism")
		.loops(1);
		...
		.sequenced_assembly(
			...
			[
				event.recipes.create.deploying(
					...
					["tfmg:unfinished_steel_mechanism", "tfmg:steel_cogwheel"],
				),
				event.recipes.create.deploying(
					"tfmg:unfinished_steel_mechanism",
					["tfmg:unfinished_steel_mechanism", "tfmg:nickel_sheet"],
				),
				event.recipes.create.deploying(
					"tfmg:unfinished_steel_mechanism",
					[
				...
				event.recipes.create.deploying(
					"tfmg:unfinished_steel_mechanism",
					["tfmg:unfinished_steel_mechanism", "tfmg:lead_sheet"],
				),
				event.recipes.create.deploying(
					"tfmg:unfinished_steel_mechanism",
					["tfmg:unfinished_steel_mechanism", "tfmg:screw"],
				),
				event.recipes.create.deploying(
					"tfmg:unfinished_steel_mechanism",
					["tfmg:unfinished_steel_mechanism", "tfmg:screwdriver"],
				),
			],
		)
	...
	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("kubejs:advanced_circuit_board", 1.0)],
		...
		.transitionalItem("kubejs:incomplete_advanced_circuit_board")
		.loops(4);

	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("kubejs:nickel_aluminide_sheet", 1.0)],
		...
		.transitionalItem("kubejs:unprocessed_nickel_aluminide_sheet")
		.loops(1);

	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("ae2:basic_card", 1.0)],
			"tfmg:aluminum_sheet",
			[
				event.recipes.create.deploying("kubejs:unfinished_basic_card", [
		...
		.transitionalItem("kubejs:unfinished_basic_card")
		.loops(1);

	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("ae2:advanced_card", 1.0)],
			"tfmg:aluminum_sheet",
			[
				event.recipes.create.deploying(
				...
				event.recipes.create.deploying(
					"kubejs:unfinished_advanced_card",
					["kubejs:unfinished_advanced_card", "ae2:logic_processor"],
				),
				event.recipes.create.deploying(
					"kubejs:unfinished_advanced_card",
					[
				...
				event.recipes.create.deploying(
					"kubejs:unfinished_advanced_card",
					["kubejs:unfinished_advanced_card", "kubejs:diamond_plate"],
				),
				event.recipes.create.deploying(
					"kubejs:unfinished_advanced_card",
					["kubejs:unfinished_advanced_card", "tfmg:plastic_sheet"],
				),
				event.recipes.create.pressing(
					"kubejs:unfinished_advanced_card",
					"kubejs:unfinished_advanced_card",
		...
		.transitionalItem("kubejs:unfinished_advanced_card")
		.loops(1);

	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("ae2:cell_component_1k", 1.0)],
			"tfmg:aluminum_sheet",
			[
				event.recipes.create.deploying(
		...
		.transitionalItem("kubejs:unfinished_1k_storage_component")
		.loops(1);

	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("ae2:cell_component_4k", 1.0)],
			"tfmg:aluminum_sheet",
			[
				event.recipes.create.deploying(
		...
		.transitionalItem("kubejs:unfinished_4k_storage_component")
		.loops(1);

	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("ae2:cell_component_16k", 1.0)],
			"tfmg:aluminum_sheet",
			[
				event.recipes.create.deploying(
		...
		.transitionalItem("kubejs:unfinished_16k_storage_component")
		.loops(1);

	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("ae2:wireless_booster", 1.0)],
			"tfmg:plastic_sheet",
			[
				event.recipes.create.deploying(
		...
		.transitionalItem("kubejs:unfinished_wireless_booster")
		.loops(1);

	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("ae2:annihilation_core", 1.0)],
			"tfmg:aluminum_sheet",
			[
				event.recipes.create.deploying(
		...
		.transitionalItem("kubejs:unfinished_annihilation_core")
		.loops(1);

	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("ae2:formation_core", 1.0)],
			"tfmg:aluminum_sheet",
			[
				event.recipes.create.deploying(
				...
				event.recipes.create.deploying(
					"kubejs:unfinished_formation_core",
					["kubejs:unfinished_formation_core", "ae2:logic_processor"],
				),
				event.recipes.create.deploying(
					"kubejs:unfinished_formation_core",
					[
		...
		.transitionalItem("kubejs:unfinished_formation_core")
		.loops(1);

	event.recipes.create
		.sequenced_assembly(
			[CreateItem.of("kubejs:motherboard", 1.0)],
			...
			[
				...
				event.recipes.create.deploying(
					"kubejs:unfinished_motherboard",
					["kubejs:unfinished_motherboard", "kubejs:redstone_wiring"],
				),
				event.recipes.create.deploying(
					"kubejs:unfinished_motherboard",
					["kubejs:unfinished_motherboard", "ae2:logic_processor"],
				),
				event.recipes.create.deploying(
					"kubejs:unfinished_motherboard",
					["kubejs:unfinished_motherboard", "kubejs:redstone_wiring"],
				...
				event.recipes.create.deploying(
					"kubejs:unfinished_motherboard",
					["kubejs:unfinished_motherboard", "ae2:memory_card"],
				),
			],
		)
	...
	event.recipes.create
		.sequenced_assembly(
			...
			[
				event.recipes.create.deploying("kubejs:unfinished_smore", [
	...
	event.recipes.create.deploying("kubejs:advanced_coated_circuit_board", [
		"kubejs:advanced_empty_circuit_board",
		"create:golden_sheet",
	]);
	event.recipes.create.deploying("kubejs:coated_motherboard", [
	...
	event.recipes.create.filling("biomesoplenty:flesh", [
	...
	event.recipes.create
		.mixing(Fluid.of("kubejs:salt_water", 500), [
			Fluid.of("minecraft:water", 500),
			Ingredient.of("#c:saltstones", 4),
		])
		.heated();
	event.recipes.create.mixing(
		CreateItem.of("minecraft:dirt", 0.75),
		"minecraft:coarse_dirt",
	);
	event.recipes.create
		.mixing("3x kubejs:steel_blast_mixture", [
			Ingredient.of("create:crushed_raw_iron", 3),
			Ingredient.of("tfmg:limesand"),
		])
		.heated();
	event.recipes.create
		.mixing(Fluid.of("kubejs:molten_electrum", 288), [
			Fluid.of("kubejs:molten_gold", 144),
			Fluid.of("kubejs:molten_silver", 144),
		])
		.heated();
	event.recipes.create
		.mixing(Fluid.of("kubejs:molten_constantan", 288), [
			Fluid.of("kubejs:molten_nickel", 144),
			Fluid.of("kubejs:molten_copper", 144),
		])
		.heated();
	event.recipes.create
		.mixing(Fluid.of("kubejs:molten_brass", 288), [
			Fluid.of("kubejs:molten_zinc", 144),
			Fluid.of("kubejs:molten_copper", 144),
		])
		.heated();
	event.recipes.create.mixing(
		["kubejs:welsh_coal", CreateItem.of("tfmg:sulfur_dust", 0.02)],
		[Fluid.of("minecraft:water", 100), Ingredient.of("minecraft:coal")],
	);
	event.recipes.create.mixing("biomesoplenty:magic_sapling", [
		"create:experience_nugget",
		"minecraft:birch_sapling",
	]);

	event.recipes.create.mixing(
		["4x minecraft:seagrass", "kubejs:seagrass_clump"],
		[
			"minecraft:bone_meal",
			"kubejs:seagrass_clump",
			Fluid.of("minecraft:water", 1000),
		],
	);
	event.recipes.create
		.mixing(Fluid.of("kubejs:algeanated_water", 250), [
	...
	event.recipes.create
		.mixing(
			...
			[
				"minecraft:tube_coral_block",
				Fluid.of("kubejs:algeanated_water", 1000),
			],
		)
		.heated();
	...
	event.recipes.create
		.mixing(Fluid.of("kubejs:molten_sodium", 144), "kubejs:sodium")
		.heated();

	event.recipes.create
		.mixing(Fluid.of("kubejs:molten_zinc", 144), "create:zinc_ingot")
		.heated();

	event.recipes.create
		.mixing(Fluid.of("kubejs:molten_copper", 144), "minecraft:copper_ingot")
		.heated();

	event.recipes.create
		.mixing(Fluid.of("kubejs:molten_iron", 144), "minecraft:iron_ingot")
		.heated();

	event.recipes.create
		.mixing(Fluid.of("kubejs:molten_gold", 144), "minecraft:gold_ingot")
		.heated();

	event.recipes.create
		.mixing(Fluid.of("kubejs:molten_silver", 144), "kubejs:silver_ingot")
		.heated();

	event.recipes.create
		.mixing(Fluid.of("kubejs:molten_lead", 144), "tfmg:lead_ingot")
		.heated();

	event.recipes.create
		.mixing(Fluid.of("kubejs:molten_nickel", 144), "tfmg:nickel_ingot")
		.heated();
	...
	event.recipes.create
		.mixing(Fluid.of("kubejs:molten_lithium", 144), "tfmg:lithium_ingot")
		.heated();

	event.recipes.create
		.mixing(Fluid.of("kubejs:molten_brass", 144), "create:brass_ingot")
		.heated();
	...
	event.recipes.create
		.mixing(Fluid.of("kubejs:molten_aluminum", 144), "tfmg:aluminum_ingot")
		.heated();
	...
	event.recipes.create
		.mixing(
			...
			["4x minecraft:clay_ball", "create:crimsite"],
		)
		.heated();

	event.recipes.create.mixing(
		["kubejs:sodium_sulfate"],
		["kubejs:sodium", Fluid.of("tfmg:sulfuric_acid", 500)],
	);
	...
	event.recipes.create
		.mixing(
			...
			["2x minecraft:sand", "create:limestone", "create:ochrum"],
		)
		.heated();
	...
	event.recipes.create
		.mixing(
			...
			["2x minecraft:sand", "create:limestone", "create:veridium"],
		)
		.heated();
	...
	event.recipes.create
		.mixing(
			...
			["create:crimsite", "minecraft:sulfur"],
		)
		.heated();

	event.recipes.create.mixing(
		["8x natures_spirit:red_moss_block"],
		["8x minecraft:moss_block", "minecraft:red_dye"],
	);

	event.recipes.create.mixing(
		["8x minecraft:moss_block"],
		["8x natures_spirit:red_moss_block", "minecraft:green_dye"],
	);
	...
	event.recipes.create
		.compacting("2x createaddition:electrum_sheet", [
			"kubejs:silver_sheet",
			"create:golden_sheet",
		])
		.heated();
	...
	event.recipes.create.compacting(
		[
			Fluid.of("biomesoplenty:blood", 50),
			CreateItem.of("minecraft:bone_meal", 0.5),
		],
		"minecraft:rotten_flesh",
	);
	event.recipes.create.compacting(
		[Fluid.of("biomesoplenty:blood", 300), "minecraft:rotten_flesh"],
		"minecraft:beef",
	);
	event.recipes.create.compacting(
		[Fluid.of("biomesoplenty:blood", 300), "minecraft:rotten_flesh"],
	...
	event.recipes.create.compacting(
		[Fluid.of("biomesoplenty:blood", 200), "minecraft:rotten_flesh"],
		"minecraft:mutton",
	);
	event.recipes.create.compacting(
		[Fluid.of("biomesoplenty:blood", 100), "minecraft:rotten_flesh"],
		"minecraft:cod",
	);
	event.recipes.create.compacting(
		[Fluid.of("biomesoplenty:blood", 100), "minecraft:rotten_flesh"],
	...
	event.recipes.create.compacting(
		[Fluid.of("biomesoplenty:blood", 150), "minecraft:rotten_flesh"],
	...
	event.recipes.create.compacting(
		[Fluid.of("biomesoplenty:blood", 50), "minecraft:rotten_flesh"],
	...
	event.recipes.create.compacting(
		[Fluid.of("biomesoplenty:blood", 200), "biomesoplenty:porous_flesh"],
		"biomesoplenty:flesh",
	);
	...
	event.recipes.create.compacting(
		[Fluid.of("biomesoplenty:blood", 100), "kubejs:raw_sausage"],
	...
	event.recipes.create.milling(
		["3x twigs:silt_ball", CreateItem.of("twigs:silt_ball", 0.5)],
		"twigs:silt",
	);
	event.recipes.create.milling(
		"kubejs:silver_dust",
	...
	event.recipes.create.milling(
		CreateItem.of("tfmg:sulfur_dust", 0.005),
		"minecraft:egg",
	);
	event.recipes.create.milling(
		["2x minecraft:black_dye", CreateItem.of("minecraft:gray_dye", 0.1)],
		"kubejs:welsh_coal",
	);
	event.recipes.create.milling(
		CreateItem.of("biomesoplenty:clover", 0.1),
	...
	event.recipes.create.crushing(
		[
			...
			CreateItem.of("tfmg:nickel_nugget", 0.09),
			CreateItem.of("create:copper_nugget", 0.07),
			CreateItem.of("create:zinc_nugget", 0.06),
			CreateItem.of("tfmg:lead_nugget", 0.03),
	...
	event.recipes.create.mechanical_crafting(
		"kubejs:potent_uranium_fuel_rod",
		["HUH", "HUH", "HUH"],
		{
			H: "tfmg:heavy_plate",
	...
	event.custom({
		...
		pattern: ["HHHHH", "HWCWH", "HWAWH", "HWCWH", "HHHHH"],
		result: {
	...
	event.custom({
		...
		pattern: ["HHHHH", "HWCWH", "HPAPH", "HWCWH", "HHHHH"],
		result: {
			id: "crowns:fuel_assembly",
			components: {
				"minecraft:custom_data": {
	...
	event.custom({
		...
		pattern: ["HHHHH", "HPCPH", "HPAPH", "HPCPH", "HHHHH"],
		result: {
			id: "crowns:fuel_assembly",
			components: {
				"minecraft:custom_data": {
	...
	event.stonecutting(
		"extra_copycats:copycat_collapsible",
		"create:zinc_ingot",
	);
	event.stonecutting(
		"extra_copycats:copycat_collapsible_grid",
		"create:zinc_ingot",
	);
	event.stonecutting(
	...
	event.recipes.create_mechanical_extruder
		.extruding(Item.of("create:asurine"), [
			BlockPredicate.of("minecraft:lava"),
			BlockPredicate.of("kubejs:tuff_mineral_slurry"),
		])
	...
	event.recipes.create_mechanical_extruder
		.extruding(Item.of("create:crimsite"), [
			BlockPredicate.of("minecraft:lava"),
			BlockPredicate.of("kubejs:tuff_mineral_slurry"),
		])
	...
	event.recipes.create_mechanical_extruder
		.extruding(Item.of("create:veridium"), [
			BlockPredicate.of("minecraft:lava"),
			BlockPredicate.of("kubejs:tuff_mineral_slurry"),
		])
	...
	event.recipes.create_mechanical_extruder
		.extruding(Item.of("create:ochrum"), [
			BlockPredicate.of("minecraft:lava"),
			BlockPredicate.of("kubejs:tuff_mineral_slurry"),
		])
	...
	event.recipes.create_mechanical_extruder
		.extruding(Item.of("dndesires:breccia"), [
			BlockPredicate.of("minecraft:lava"),
			BlockPredicate.of("kubejs:tuff_mineral_slurry"),
		])
	...
	event.recipes.create_mechanical_extruder
		.extruding(Item.of("tfmg:bauxite"), [
			BlockPredicate.of("minecraft:lava"),
			BlockPredicate.of("kubejs:tuff_mineral_slurry"),
		])
		...
		.advanced(true)
		.consumeBlocks(true)
		.requirements([RecipeRequirement.maxSpeed(32.0)]);

	event.recipes.create_mechanical_extruder
		.extruding(Item.of("tfmg:galena"), [
			BlockPredicate.of("minecraft:lava"),
			BlockPredicate.of("kubejs:tuff_mineral_slurry"),
		])
	...
	event.recipes.create_mechanical_extruder
		.extruding(Item.of("minecraft:dripstone_block"), [
			BlockPredicate.of("minecraft:lava"),
			BlockPredicate.of("kubejs:tuff_mineral_slurry"),
		])
	...
	event.recipes.create_mechanical_extruder
		.extruding(Item.of("minecraft:basalt"), [
			BlockPredicate.of("minecraft:lava"),
	...
	event.recipes.create_mechanical_extruder
		.extruding(Item.of("minecraft:end_stone"), [
			BlockPredicate.of("minecraft:lava"),
			BlockPredicate.of("minecraft:blue_ice"),
		])
		.advanced(true)
	...
	event.recipes.create_mechanical_extruder
		.extruding(Item.of("minecraft:snow_block"), [
	...
	event.recipes.create_mechanical_extruder
		.extruding(Item.of("minecraft:sandstone"), [
			BlockPredicate.of("minecraft:water"),
	...
	event.recipes.create_mechanical_extruder
		.extruding(Item.of("minecraft:obsidian"), [
			BlockPredicate.of("minecraft:water"),
			BlockPredicate.of("minecraft:lava"),
		])
		.advanced(true)
	...
	event.recipes.create_mechanical_extruder
		.extruding(Item.of("create:scoria"), [
			BlockPredicate.of("minecraft:lava"),
	...
	event.shaped("kubejs:silver_ingot", ["AAA", "AAA", "AAA"], {
		A: "kubejs:silver_nugget",
	});

	event.shaped("9x kubejs:silver_nugget", ["A"], {
		A: "kubejs:silver_ingot",
	});

	event.shaped("kubejs:stored_uranium_ingots", ["AAA", "AAA", "AAA"], {
		A: "crowns:uranium_ingot",
	});

	event.shaped("9x crowns:uranium_ingot", ["A"], {
		A: "kubejs:stored_uranium_ingots",
	});

	event.shaped(
		"kubejs:stored_nickel_aluminide_ingots",
		["AAA", "AAA", "AAA"],
		{
	...
	event.shaped("9x kubejs:nickel_aluminide_ingot", ["A"], {
		A: "kubejs:stored_nickel_aluminide_ingots",
	});

	event.shaped("kubejs:stored_silver_ingots", ["AAA", "AAA", "AAA"], {
		A: "kubejs:silver_ingot",
	});

	event.shaped("9x kubejs:silver_ingot", ["A"], {
		A: "kubejs:stored_silver_ingots",
	});

	event.shaped("supplementaries:sack", ["ABA", "A A", "AAA"], {
		A: "minecraft:wheat",
		B: "#c:strings",
	});
	...
	event.shaped("kubejs:wooden_mechanism", ["AB", "CD"], {
		A: "create:cogwheel",
		B: "minecraft:lever",
	...
	event.shaped("kubejs:andesite_alloy_mechanism", ["ABC", "DEF", " G "], {
		A: "create:cogwheel",
	...
	event.shaped("kubejs:andesite_alloy_mechanism_casing", ["A A", " B "], {
		A: "create:andesite_alloy",
		B: "create:iron_sheet",
	});

	event.shaped("dndesires:gold_whisk", [" A ", "BAB", "BBB"], {
		A: "create:andesite_alloy",
		B: "create:brass_sheet",
	});

	event.shaped("4x minecraft:arrow", ["A", "B", "C"], {
		A: "minecraft:flint",
		B: "minecraft:stick",
		C: "farmersdelight:canvas",
	});

	event.shaped("minecraft:phantom_membrane", ["ABA", "BAB", "ABA"], {
		A: "minecraft:string",
		B: "minecraft:bone_meal",
	});

	event.shaped("comforts:sleeping_bag_white", ["AA", "AA", "AA"], {
		A: "farmersdelight:canvas",
	});

	event.shaped("kubejs:stored_canvas", ["AAA", "AAA", "AAA"], {
		A: "farmersdelight:canvas",
	});

	event.shaped("9x farmersdelight:canvas", ["A"], {
		A: "kubejs:stored_canvas",
	});

	event.shaped("tfmg:copper_grenade", [" A ", "ABA", " A "], {
		A: "tfmg:thermite_powder",
		B: "tfmg:aluminum_ingot",
	});

	event.shaped("kubejs:advanced_empty_circuit_board", [" A ", "BBB", "CCC"], {
		A: "minecraft:red_dye",
		B: "ae2:silicon",
		C: "tfmg:plastic_sheet",
	});

	event.shaped("kubejs:empty_motherboard", [" A ", "BBB", "CCC"], {
		A: "minecraft:blue_dye",
		B: "ae2:printed_silicon",
		C: "tfmg:plastic_sheet",
	});

	event.shaped("kubejs:seagrass_clump", ["AAA", "AAA", "AAA"], {
		A: "minecraft:seagrass",
	});

	event.shaped("minecraft:tube_coral_block", ["AA", "AA"], {
		A: "minecraft:tube_coral",
	});

	event.shaped("4x minecraft:tube_coral", ["A"], {
		A: "minecraft:tube_coral_block",
	});

	event.shaped("minecraft:brain_coral_block", ["AA", "AA"], {
		A: "minecraft:brain_coral",
	});

	event.shaped("4x minecraft:brain_coral", ["A"], {
		A: "minecraft:brain_coral_block",
	});

	event.shaped("minecraft:bubble_coral_block", ["AA", "AA"], {
		A: "minecraft:bubble_coral",
	});

	event.shaped("4x minecraft:bubble_coral", ["A"], {
		A: "minecraft:bubble_coral_block",
	});

	event.shaped("minecraft:fire_coral_block", ["AA", "AA"], {
		A: "minecraft:fire_coral",
	});

	event.shaped("4x minecraft:fire_coral", ["A"], {
		A: "minecraft:fire_coral_block",
	});

	event.shaped("minecraft:horn_coral_block", ["AA", "AA"], {
		A: "minecraft:horn_coral",
	});

	event.shaped("4x minecraft:horn_coral", ["A"], {
		A: "minecraft:horn_coral_block",
	});

	//Organic Rubber/Rubber Sheet Recipes

	event.shaped("create:belt_connector", ["AAA", "AAA"], {
		A: "kubejs:organic_rubber",
	});

	event.shaped("4x create:belt_connector", ["AAA", "AAA"], {
		A: "tfmg:rubber_sheet",
	});

	event.shaped("create:spout", ["A", "B"], {
		A: "create:copper_casing",
		B: "kubejs:organic_rubber",
	});

	event.shaped("4x create:spout", ["A", "B"], {
		A: "create:copper_casing",
		B: "tfmg:rubber_sheet",
	});

	event.shaped("2x create:andesite_funnel", ["A", "B"], {
		A: "create:andesite_alloy",
		B: "kubejs:organic_rubber",
	});

	event.shaped("8x create:andesite_funnel", ["A", "B"], {
		A: "create:andesite_alloy",
		B: "tfmg:rubber_sheet",
	});

	event.shaped("2x create:brass_funnel", ["A", "B", "C"], {
		A: "create:electron_tube",
		B: "create:brass_ingot",
		C: "kubejs:organic_rubber",
	});

	event.shaped("8x create:brass_funnel", ["A", "B", "C"], {
		A: "create:electron_tube",
		B: "create:brass_ingot",
		C: "tfmg:rubber_sheet",
	});

	event.shaped("2x create:andesite_tunnel", ["AA", "BB"], {
		A: "create:andesite_alloy",
		B: "kubejs:organic_rubber",
	});

	event.shaped("8x create:andesite_tunnel", ["AA", "BB"], {
		A: "create:andesite_alloy",
		B: "tfmg:rubber_sheet",
	});

	event.shaped("2x create:brass_tunnel", ["A ", "BB", "CC"], {
		A: "create:electron_tube",
		B: "create:brass_ingot",
		C: "kubejs:organic_rubber",
	});

	event.shaped("8x create:brass_tunnel", ["A ", "BB", "CC"], {
		A: "create:electron_tube",
		B: "create:brass_ingot",
		C: "tfmg:rubber_sheet",
	});
	...
	event.shaped("ae2:nether_quartz_cutting_knife", ["  A", " B ", "C  "], {
		A: "kubejs:quartz_plate",
		B: "tfmg:steel_ingot",
		C: "minecraft:stick",
	});

	event.shaped("ae2:certus_quartz_cutting_knife", ["  A", " B ", "C  "], {
		A: "#c:plates/certus_quartz",
		B: "tfmg:steel_ingot",
		C: "minecraft:stick",
	});

	event.shaped("ae2:nether_quartz_wrench", ["  A", " B ", "B  "], {
		A: "kubejs:quartz_plate",
		B: "tfmg:steel_ingot",
	});

	event.shaped("ae2:certus_quartz_wrench", ["  A", " B ", "B  "], {
		A: "#c:plates/certus_quartz",
		B: "tfmg:steel_ingot",
	});

	event.shaped("ae2:entropy_manipulator", [" AB", " CD", "C  "], {
	...
	event.shaped("ae2:wireless_terminal", ["A  ", "BCB", "DED"], {
	...
	event.shaped("ae2:wireless_crafting_terminal", ["A", "B", "C"], {
		A: "ae2:wireless_terminal",
		B: "ae2:calculation_processor",
		C: "ae2:crafting_card",
	});

	event.shaped("ae2:charged_staff", ["  A", " B ", "B  "], {
		A: "kubejs:charged_certus_quartz_plate",
		B: "kubejs:aluminum_rod",
	});

	event.shaped("ae2:color_applicator", [" AB", "CDA", " E "], {
	...
	event.shaped("ae2:network_tool", ["AB ", "CDE", " F "], {
	...
	event.shaped("ae2:meteorite_compass", [" A ", "ABA", " A "], {
		A: "tfmg:aluminum_sheet",
		B: "ae2:charged_certus_quartz_crystal",
	});

	event.shaped("ae2:guide", ["A", "B", "C"], {
		A: "#c:plates/certus_quartz",
		B: "minecraft:book",
		C: "tfmg:aluminum_sheet",
	});

	event.shaped("ae2:fluix_upgrade_smithing_template", ["A", "B", "A"], {
		A: "tfmg:aluminum_sheet",
		B: "kubejs:fluix_crystal_plate",
	});
	...
	event.shaped("kubejs:lithium_battery_module", ["A", "B", "B"], {
		A: "kubejs:charged_certus_quartz_plate",
		B: "tfmg:lithium_charge",
	});

	event.shaped("kubejs:calculation_inscribing_template", ["A", "B"], {
		A: "kubejs:steel_rod",
		B: "tfmg:heavy_plate",
	});

	event.shaped("kubejs:logic_inscribing_template", ["A", "B"], {
		A: "kubejs:steel_rod",
		B: "tfmg:heavy_plate",
	});

	event.shaped("kubejs:engineering_inscribing_template", ["A", "B"], {
		A: "kubejs:steel_rod",
		B: "tfmg:heavy_plate",
	});

	event.shaped("kubejs:silicon_inscribing_template", ["A", "B"], {
		A: "kubejs:steel_rod",
		B: "tfmg:heavy_plate",
	});
	...
	event.shaped("2x ae2:blank_pattern", ["ABA", "BCB", "DDD"], {
		A: "ae2:quartz_glass",
	...
	event.shaped("ae2:memory_card", ["ABB", "CDC"], {
	...
	event.shaped("ae2:item_cell_housing", ["ABA", "CDC", "CEC"], {
		A: "ae2:quartz_glass",
		B: "create:iron_sheet",
		C: "tfmg:plastic_sheet",
		D: "kubejs:redstone_wiring",
	...
	event.shaped("ae2:fluid_cell_housing", ["ABA", "CDC", "CEC"], {
		A: "ae2:quartz_glass",
		B: "create:copper_sheet",
		C: "tfmg:plastic_sheet",
		D: "kubejs:redstone_wiring",
	...
	event.shaped("ae2:wireless_receiver", [" A ", "BCB", "BBB"], {
		A: "ae2:fluix_pearl",
		B: "tfmg:aluminum_sheet",
		C: "ae2:quartz_fiber",
	});

	event.shaped("ae2:inscriber", ["ABA", "C C", "ADA"], {
	...
	event.shaped("ae2:wireless_access_point", [" A ", " B ", "CDC"], {
		A: "ae2:wireless_receiver",
		B: "ae2:calculation_processor",
	...
	event.shaped("ae2:charger", ["ABA", "C C", "ADA"], {
		A: "tfmg:aluminum_ingot",
	...
	event.shaped("ae2:controller", ["ABA", "BCB", "ADA"], {
		A: "tfmg:aluminum_ingot",
		B: "kubejs:fluix_crystal_plate",
	...
	event.shaped("ae2:drive", ["ABA", "C C", "ABA"], {
		A: "tfmg:aluminum_ingot",
		B: "ae2:engineering_processor",
		C: "ae2:fluix_glass_cable",
	});

	event.shaped("ae2:interface", ["ABA", "CDE", "ABA"], {
		A: "tfmg:aluminum_ingot",
		B: "ae2:quartz_glass",
	...
	event.shaped("ae2:cell_workbench", ["ABA", "CDC", "CEC"], {
		A: "#minecraft:wool",
		B: "ae2:calculation_processor",
		C: "tfmg:aluminum_ingot",
		D: "#create_vibrant_vaults:item_vaults",
	...
	event.shaped("ae2:crafting_unit", ["ABA", "CDC", "ABA"], {
		A: "tfmg:aluminum_ingot",
		B: "ae2:calculation_processor",
		C: "ae2:fluix_glass_cable",
	...
	event.shaped("ae2:pattern_provider", ["ABA", "CDE", "AAA"], {
		A: "tfmg:aluminum_ingot",
		B: "ae2:crafting_card",
		C: "ae2:annihilation_core",
		D: "kubejs:advanced_circuit_board",
	...
	event.shaped("ae2:molecular_assembler", ["ABA", "CDE", "AFA"], {
		A: "tfmg:aluminum_ingot",
		B: "ae2:quartz_glass",
		C: "ae2:annihilation_core",
		D: "ae2:crafting_card",
	...
	event.shaped("3x ae2:semi_dark_monitor", [" AB", "CDB", " AB"], {
	...
	event.shaped("ae2:storage_bus", ["ABA"], {
		A: "create:mechanical_press",
		B: "#ae2:interface",
	});

	event.shaped("ae2:import_bus", [" A ", "BCB"], {
		A: "ae2:annihilation_core",
		B: "tfmg:aluminum_ingot",
		C: "create:mechanical_press",
	});

	event.shaped("ae2:export_bus", ["ABA", " C "], {
		A: "tfmg:aluminum_ingot",
		B: "ae2:formation_core",
		C: "create:mechanical_press",
	});

	event.shaped("ae2:crafting_terminal", ["ABC"], {
		A: "ae2:terminal",
		B: "ae2:crafting_card",
		C: "ae2:calculation_processor",
	});

	event.shaped("ae2:me_p2p_tunnel", [" A ", "ABA", "CCC"], {
		A: "tfmg:aluminum_ingot",
		B: "ae2:engineering_processor",
		C: "kubejs:fluix_crystal_plate",
	});
	...
	event.shaped("computercraft:monitor_normal", ["AAA", "ABA", "AAA"], {
		A: "tfmg:aluminum_sheet",
		B: "ae2:semi_dark_monitor",
	});

	event.shaped("computercraft:monitor_advanced", ["AAA", "ABA", "AAA"], {
		A: "tfmg:plastic_sheet",
		B: "ae2:semi_dark_monitor",
	});

	event.shaped("computercraft:speaker", ["AAA", "ABA", "ACA"], {
		A: "tfmg:aluminum_sheet",
		B: "minecraft:note_block",
		C: "tfmg:circuit_board",
	});

	event.shaped("computercraft:printer", ["AAA", "ABA", "ACA"], {
		A: "tfmg:aluminum_sheet",
		B: "kubejs:redstone_wiring",
		C: "#c:dyes",
	});

	event.shaped("computercraft:disk_drive", ["AAA", "ABA", "ACA"], {
		A: "tfmg:aluminum_sheet",
		B: "ae2:drive",
		C: "kubejs:redstone_wiring",
	});

	event.shaped("computercraft:redstone_relay", ["ABA", "BCB", "ABA"], {
		A: "tfmg:aluminum_sheet",
		B: "kubejs:redstone_wiring",
		C: "computercraft:wired_modem",
	});

	event.shaped("computercraft:wired_modem", ["AAA", "ABA", "AAA"], {
		A: "tfmg:aluminum_sheet",
		B: "kubejs:redstone_wiring",
	});

	event.shaped("6x computercraft:cable", [" A ", "ABA", " A "], {
		A: "tfmg:aluminum_sheet",
		B: "kubejs:redstone_wiring",
	});

	event.shaped("computercraft:wireless_modem_normal", ["ABA", "ACA", "AAA"], {
		A: "tfmg:aluminum_sheet",
	...
	event.shaped(
		"armourers_workshop:hologram-projector",
		["ABA", "ACA", "ADA"],
		{
	...
	event.shapeless(Item.of("kubejs:aluminum_silver_catalyst", 1), [
		"tfmg:aluminum_sheet",
		"kubejs:silver_sheet",
	]);
	...
	event
		.shapeless("kubejs:marshmallow", ["kubejs:marshmallow_on_a_stick"])
		.replaceIngredient("kubejs:marshmallow_on_a_stick", "minecraft:stick");

	event
		.shapeless("kubejs:cooked_marshmallow", [
			"kubejs:cooked_marshmallow_on_a_stick",
		])
		.replaceIngredient(
			"kubejs:cooked_marshmallow_on_a_stick",
	...
	event.recipes.create.cutting("kubejs:hot_dog_bun", "minecraft:bread");
	...
	event.shaped("immersive_aircraft:engine", [" A ", "BCB", "DED"], {
	...
	event.shaped("immersive_aircraft:sail", ["AA", "AA"], {
		A: "create:white_sail",
	});
	...
	event.shaped("immersive_aircraft:boiler", ["AAA", "ABA", "CCC"], {
		A: "create:copper_sheet",
		B: "minecraft:furnace",
	...
	event.shaped("immersive_aircraft:eco_engine", ["AAA", "BCB", "DED"], {
		A: "create:copper_sheet",
	...
	event.shaped("immersive_aircraft:nether_engine", ["AAA", "BCB", "DED"], {
		A: "tfmg:heavy_plate",
		B: "create:sturdy_sheet",
		C: "immersive_aircraft:engine",
		D: "tfmg:steel_ingot",
	...
	event.shaped("immersive_aircraft:steel_boiler", ["AAA", "ABA", "CDC"], {
		A: "create:iron_sheet",
	...
	event.shaped("immersive_aircraft:industrial_gears", ["CB", "AD"], {
	...
	event.shaped("immersive_aircraft:gyroscope", ["ABA"], {
		A: "create:electron_tube",
		B: "minecraft:compass",
	});

	event.shaped("immersive_aircraft:gyroscope_hud", ["AAA", "BCB", "DEF"], {
		A: "#c:glass_panes",
		B: "create:brass_sheet",
	...
	event.shaped("immersive_aircraft:gyroscope_dials", ["ABA", "CDC", "ECF"], {
		A: "minecraft:compass",
		B: "minecraft:clock",
		C: "create:iron_sheet",
	...
	event.shaped(
		"4x immersive_aircraft:improved_landing_gear",
		[" AA", "BBC", "BB "],
		{
			A: "create:iron_sheet",
			B: "tfmg:rubber_sheet",
	...
	event.shaped("immersive_aircraft:heavy_crossbow", ["A", "B", "C"], {
		A: "create:iron_sheet",
	...
	event.shaped("immersive_aircraft:rotary_cannon", [" A ", "BCB", " D "], {
		A: "create:copper_sheet",
	...
	event.shaped("immersive_aircraft:bomb_bay", ["ABA", "A A"], {
		A: "tfmg:heavy_plate",
		B: "minecraft:tnt",
	});
	...
	event.shapeless(Item.of("minecraft:brown_dye", 2), [
		"minecraft:red_dye",
		"minecraft:green_dye",
	]);
	...
	event.shapeless(Item.of("minecraft:brown_dye", 3), [
		"minecraft:red_dye",
		"minecraft:blue_dye",
	...
	event.shapeless(Item.of("minecraft:green_dye", 2), [
		"minecraft:yellow_dye",
		"minecraft:blue_dye",
	]);

	event.shapeless(Item.of("minecraft:cyan_dye", 3), [
		"minecraft:yellow_dye",
		"minecraft:blue_dye",
		"minecraft:blue_dye",
	]);
	...
	event.recipes.create.mixing(
		Fluid.of("create_dragons_plus:orange_dye", 500),
		[
			Fluid.of("create_dragons_plus:red_dye", 250),
			Fluid.of("create_dragons_plus:yellow_dye", 250),
		],
	);
	event.recipes.create.mixing(Fluid.of("create_dragons_plus:lime_dye", 500), [
		Fluid.of("create_dragons_plus:white_dye", 250),
		Fluid.of("create_dragons_plus:green_dye", 250),
	]);
	event.recipes.create.mixing(
		Fluid.of("create_dragons_plus:green_dye", 500),
		[
			Fluid.of("create_dragons_plus:yellow_dye", 250),
			Fluid.of("create_dragons_plus:blue_dye", 250),
		],
	);
	event.recipes.create.mixing(Fluid.of("create_dragons_plus:cyan_dye", 500), [
		Fluid.of("create_dragons_plus:green_dye", 250),
		Fluid.of("create_dragons_plus:blue_dye", 250),
	]);
	event.recipes.create.mixing(Fluid.of("create_dragons_plus:cyan_dye", 750), [
		Fluid.of("create_dragons_plus:yellow_dye", 250),
		Fluid.of("create_dragons_plus:blue_dye", 500),
	]);
	event.recipes.create.mixing(
		Fluid.of("create_dragons_plus:light_blue_dye", 500),
		[
			Fluid.of("create_dragons_plus:white_dye", 250),
			Fluid.of("create_dragons_plus:blue_dye", 250),
		],
	...
	event.recipes.create.mixing(
		Fluid.of("create_dragons_plus:purple_dye", 500),
		[
			Fluid.of("create_dragons_plus:red_dye", 250),
			Fluid.of("create_dragons_plus:blue_dye", 250),
		],
	...
	event.recipes.create.mixing(
		Fluid.of("create_dragons_plus:magenta_dye", 500),
		[
			Fluid.of("create_dragons_plus:purple_dye", 250),
			Fluid.of("create_dragons_plus:pink_dye", 250),
		],
	);
	event.recipes.create.mixing(Fluid.of("create_dragons_plus:pink_dye", 500), [
		Fluid.of("create_dragons_plus:red_dye", 250),
		Fluid.of("create_dragons_plus:white_dye", 250),
	]);
	event.recipes.create.mixing(
		Fluid.of("create_dragons_plus:light_gray_dye", 500),
		[
			Fluid.of("create_dragons_plus:gray_dye", 250),
			Fluid.of("create_dragons_plus:white_dye", 250),
		],
	);
	event.recipes.create.mixing(
		Fluid.of("create_dragons_plus:light_gray_dye", 750),
		[
			Fluid.of("create_dragons_plus:black_dye", 250),
			Fluid.of("create_dragons_plus:white_dye", 500),
		],
	);
	event.recipes.create.mixing(Fluid.of("create_dragons_plus:gray_dye", 500), [
		Fluid.of("create_dragons_plus:black_dye", 250),
		Fluid.of("create_dragons_plus:white_dye", 250),
	]);
	event.recipes.create.mixing(
		Fluid.of("create_dragons_plus:brown_dye", 500),
		[
			Fluid.of("create_dragons_plus:red_dye", 250),
			Fluid.of("create_dragons_plus:green_dye", 250),
		],
