...
StartupEvents.registry("item", event => {
	...
	event
		.create("electron_circuit_board")
		.tooltip("Now lights up!");
	event
		.create("yellowcake_uranium_powder")
		.tooltip("Gamma flavoured");
	event
		.create("uranium_pellets")
		.tooltip("The opposite of Iodine pills");
	event
		.create("potent_uranium_fuel_rod")
		.tooltip("20 Trillion Calories");
	event.create("weak_uranium_fuel_rod");
	event.create("crushed_raw_silver");
	event.create("silver_dust");
	event.create("silver_ingot");
	event
		.create("silver_nugget")
		.tooltip("Jack's grandpa was a silver smith");
	...
	event
		.create("aluminum_silver_catalyst")
		.tooltip("...Why?");
	event
		.create(
	...
	event
		.create("uranium_dioxide")
		.tooltip("UO₂");
	event
		.create("potassium_fluoride")
		.tooltip("KF");
	event
		.create("potassium_carbonate")
		.tooltip("K₂CO₃");
	event
		.create("potassium_chloride")
		.tooltip("KCl");
	event
		.create("calcium_fluoride")
		.tooltip("CaF₂");
	event
		.create("potassium_hydroxide")
		.tooltip("KOH");
	...
	event
		.create("natures_spirit:coconut_shell")
		.tooltip("Can be used to make a wooden mechanism?");
});
